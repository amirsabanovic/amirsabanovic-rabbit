...
import com.academics.repositories.FacultyMemberRepository;
...
public class FacultyMemberService {
	...
	@RabbitListener(queues = "post-faculty-member-academics")
	...
	@RabbitListener(queues = "put-faculty-member-academics")
	...
	@RabbitListener(queues = "delete-faculty-member-academics")
