...
public class RabbitMQConfiguration {
	...
	final static String postFacultyMemberAcademicsQueueName = "post-faculty-member-academics";
	final static String putFacultyMemberAcademicsQueueName = "put-faculty-member-academics";
	final static String deleteFacultyMemberAcademicsQueueName = "delete-faculty-member-academics";
    ...
    @Bean
    Queue postFacultyMemberAcademicsQueue() {
        return new Queue(postFacultyMemberAcademicsQueueName, false);
    }
    
    @Bean
    Queue putFacultyMemberAcademicsQueue() {
    	return new Queue(putFacultyMemberAcademicsQueueName, false);
    }
    
    @Bean
    Queue deleteFacultyMemberAcademicsQueue() {
    	return new Queue(deleteFacultyMemberAcademicsQueueName, false);
    }
    ...
    @Bean
    Binding postFacultyMemberAcademicsbinding(Queue postFacultyMemberAcademicsQueue, DirectExchange usersExchange) {
        return BindingBuilder.bind(postFacultyMemberAcademicsQueue).to(usersExchange).with("post.faculty.member.academics");
    }
    
    @Bean
    Binding putFacultyMemberAcademicsbinding(Queue putFacultyMemberAcademicsQueue, DirectExchange usersExchange) {
        return BindingBuilder.bind(putFacultyMemberAcademicsQueue).to(usersExchange).with("put.faculty.member.academics");
    }
    
    @Bean
    Binding deleteFacultyMemberAcademicsbinding(Queue deleteFacultyMemberAcademicsQueue, DirectExchange usersExchange) {
        return BindingBuilder.bind(deleteFacultyMemberAcademicsQueue).to(usersExchange).with("delete.faculty.member.academics");
    }
